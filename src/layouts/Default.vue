<template>
  <div class="layout">
    <header class="h-24 sm:h-32 flex items-center z-30 w-full bg-gray-50">
      <div class="container mx-auto flex items-center justify-between">
        <div
          class="uppercase text-green-500 dark:text-white font-black text-xl"
        >
          <g-link to="/">{{ $static.metadata.siteName }}</g-link>
        </div>
        <div class="flex items-center">
          <nav
            class="text-gray-800 dark:text-white uppercase text-md lg:flex items-center hidden"
          >
            <a href="#" class="py-2 px-6 hover:text-green-700"> Home </a>
            <a href="#" class="py-2 px-6 hover:text-green-700"> About </a>
            <a href="#" class="py-2 px-6 hover:text-green-700"> Contact </a>
            <a href="#" class="py-2 pl-6 hover:text-green-700"> Work </a>
          </nav>
    ...
    <footer class="bg-gray-50 dark:bg-gray-800 w-full py-8 mt-40">
