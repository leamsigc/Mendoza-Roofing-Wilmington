...
/**
 *
 * Component Description: Global footer with company information and navigation links.
 *
...
<template>
    <footer class="bg-navy-900 text-white py-12 border-t border-gold-500">
        <UContainer>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        <li>
                            <NuxtLink to="#" class="hover:text-gold-500">Residential Roofing</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="#" class="hover:text-gold-500">Commercial Roofing</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="#" class="hover:text-gold-500">Repairs & Maintenance</NuxtLink>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        <li>
                            <NuxtLink :to="useLocalePath()('about')" class="hover:text-gold-500">{{ t('nav.about') }}
                            </NuxtLink>
                        </li>
                        <li>
