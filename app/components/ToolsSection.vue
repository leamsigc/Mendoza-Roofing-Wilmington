        ...
        <div class="max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div
                ...
                <div class="flex flex-wrap gap-3">
                    <NuxtLink v-for="(keyword, idx) in SEO_KEYWORDS.slice(0, 15)" :key="idx" to="/contact"
                        class="group flex items-center gap-2 px-4 py-2 bg-gray-50 dark:bg-navy-950 border border-gray-200 dark:border-navy-800 rounded-sm text-sm font-bold text-navy-700 dark:text-gray-300 uppercase tracking-wide hover:border-gold-500 hover:text-gold-600 dark:hover:text-gold-500 transition-all">
